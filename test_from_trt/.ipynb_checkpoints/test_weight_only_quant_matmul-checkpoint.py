...
class TestWeightOnlyQuantMatmul(unittest.TestCase):
    ...
    @parameterized.expand(
        [
            ...
            # (4, 1024, 512, 1, True),
            # (8, 1024, 512, 1, True),
            # (1, 6144, 12288, 1, True),  # FP16 * INT8
            # (1, 6144, 12288, 1, False),  # FP16 * INT8
            # (1, 1024, 4096, 2, True),
            # (8, 1024, 512, 2, True),
            # (16, 1024, 256, 2, True),
            # (1, 4096, 1536, 0, True),  # FP16 * INT4
            (1, 4096, 1536 * 16, 1, True),  # FP16 * INT4
            (1, 4096, 1536 * 16, 1, False),  # FP16 * INT4
            # (64, 4096 * 8, 1536 * 8, 1, True),  # FP16 * INT4
            # (128, 4096 * 8, 1536 * 8, 1, True),  # FP16 * INT4
            # (256, 4096 * 8, 1536 * 8, 1, True),  # FP16 * INT4
            # (32, 4096 * 8, 1536 * 8, 1, True),  # FP16 * INT4
            (512, 4096, 1536 * 16, 1, True),  # FP16 * INT4
            (512, 4096, 1536 * 16, 1, False),  # FP16 * INT4
            (1024, 4096, 1536 * 16, 1, True),  # FP16 * INT4
            (1024, 4096, 1536 * 16, 1, False),  # FP16 * INT4
            (1, 4096, 1536 * 16, 2, True),  # FP16 * INT4
            # (1, 4096, 1536, 2, False),  # FP16 * INT4
            # (64, 4096 * 8, 1536 * 8, 2, True),  # FP16 * INT4
            # (128, 4096 * 8, 1536 * 8, 2, True),  # FP16 * INT4
            # (256, 4096 * 8, 1536 * 8, 2, True),  # FP16 * INT4
            # (32, 4096 * 8, 1536 * 8, 2, True),  # FP16 * INT4
            (1024, 4096, 1536 * 16, 2, True),  # FP16 * INT4
            (1024, 4096, 1536 * 16, 2, True),  # FP16 * INT4
            # (512, 4096, 1536, 2, False),  # FP16 * INT4
        ],
